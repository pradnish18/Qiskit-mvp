...
export const EventFormatSection: React.FC = () => {
  ...
  // Phase I values (Hold 1 -> gently fade out and translate up -20px)
  const phase1Opacity = 1 - easedTrans;
  const phase1TranslateY = -easedTrans * 20;

  // Phase II values (Emerge from +20px and fade in 0 -> 1)
  const phase2Opacity = easedTrans;
  const phase2TranslateY = (1 - easedTrans) * 20;
            ...
            <div className="lg:col-span-7 flex flex-col justify-center">
              ...
              <div className="hidden lg:flex items-center gap-8 pl-4">
                ...
                <div className="relative w-full min-h-[360px] grid grid-cols-1 grid-rows-1 items-center">
                  ...
                  {/* PHASE I LAYER */}
                  <article
                    className="col-start-1 row-start-1 will-change-transform transition-all duration-100 ease-out"
                    style={{
