  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 z-10">
        ...
        {/* Section Bottom Datum: Clean, dignified transition leading toward future Registration */}
        <div
          className="mt-20 pt-8 border-t border-white/[0.08] flex flex-col sm:flex-row items-baseline justify-between gap-4 font-mono-tech text-xs text-slate-500 select-none"
          aria-hidden="true"
        >
          <div className="flex items-center gap-2 text-[11px] uppercase tracking-[0.2em] text-slate-400">
            ...
            <span>QISKIT FALL FEST 2026 · CURRICULUM FRAMEWORK</span>
          </div>
          <div className="text-[11px] text-slate-500 tracking-wider">
            PARTNER PLUS HOST · SRM UNIVERSITY-AP
          </div>
        </div>
      </div>
    </section>
